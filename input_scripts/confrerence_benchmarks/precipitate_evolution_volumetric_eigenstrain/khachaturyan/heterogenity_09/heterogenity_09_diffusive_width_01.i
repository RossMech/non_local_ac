mesh_file = '/home/rnizinkovskyi/projects/non_local_ac/input_scripts/confrerence_benchmarks/precipitate_evolution_volumetric_eigenstrain/single_precipitate_volumetric_delta_09.msh'
...
[Materials]
  ...
  [./const]
    ...
    prop_values = '1.0 1.5  0.3049  0.2952'
  [../]
  # =========================================================Switching Functions
  [./wa]
  ...
  [./eigenstrain]
    ...
    eigen_base = '0.001 0.001 0.0 0.0 0.0 0.0'
		prefactor = ha
    args = 'etaa'
