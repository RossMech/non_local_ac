...
[Materials]
  ...
  [./const]
    ...
    prop_values = '1.0  2.4363    0.6608    0.0896     0.0206    6.0'
  [../]
	[./denom]
	...
	#	f_name = kappa2
	#	args = 'etaa etab etac'
	#	material_property_names = 'kappa1 kappa_ab'
	#	function = 'if(kappa1 > kappa_ab,kappa_ab,kappa1)'
	#	outputs = exodus
	#[../]
	#[./kappa]
	#	type = DerivativeParsedMaterial
	#	f_name = kappa
	#	args = 'etaa etab etac'
	#	material_property_names = 'kappa2 kappa_bc'
	#	function = 'if(kappa2 < 0.0,0.0,kappa2)'
	#	outputs = exodus
	#[../]
  # ============================================================Bulk free energy
  [./f_bulk]
