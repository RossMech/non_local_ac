...
[Materials]
  ...
  [./const]
    ...
    prop_values = '1.0  2.4363    0.6608    0.0448     0.0103    12.0  1e0'
  [../]
	[./denom]
  ...
  [./f_bulk]
    ...
    -etab*etab/2)+((etac*etac*etac*etac/4-etac*etac/2))
		+(gab*etaa*etaa*(etab*etab+etac*etac)+gbc*etab*etab*etac*etac)+1/4) + penalty*etaa*etab*etac'
	[../]
	[./penalty_ternary]
		type = DerivativeParsedMaterial
		f_name = penalty_ternary
		args = 'etaa etab etac'
		material_property_names = 'penalty'
		function = 'penalty*etaa*etab*etac'
	[../]
	# =========================================================Switching Functions
	[./wb]
		type = DerivativeParsedMaterial
  ...
  [../]
	...
	[./modified_energy]
		...
		f_name = f_modified
		args = 'etaa etab etac'
		sum_materials = 'f_elast penalty_ternary'
	[../]
[]
