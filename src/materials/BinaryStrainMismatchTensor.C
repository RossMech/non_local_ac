#include "BinaryStrainMismatchTensor.h"
...
BinaryStrainMismatchTensor::validParams()
{
	...
	params.addRequiredParam<MaterialPropertyName>("delta_elasticity","difference in elastic properties between phases");
...
BinaryStrainMismatchTensor::BinaryStrainMismatchTensor(const InputParameters & parameters)
...
void BinaryStrainMismatchTensor::computeQpProperties()
{
